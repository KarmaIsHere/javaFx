...
public class ManagerViewTrip implements Initializable {
    ...
    public void fetchStopPoints(ActionEvent actionEvent) {
    }

    public void createTrip(ActionEvent actionEvent) throws IOException {
        switchScene("newTripCreationSequence/fillTripDetails.fxml", createButton);
    }
}
